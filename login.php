        ...
        <div class="div-40-center">
            ...
            <div class="card pad space">
                ...
                <div class="card-body">
                    ...
                    <p class="txt-center"><i><i class="fa fa-quote-left" aria-hidden="true"></i> Art of Teaching. Heart for Learning. asd</i> <i class="fa fa-quote-right" aria-hidden="true"></i></p>
                        <form method="POST">
                           <div class="md-form">
